Rails.application.configure do
  ...
  config.action_mailer.delivery_method = :destroy_admin_user_session_path
  config.action_mailer.smtp_settings = {
    :authentication => :plain,
    :address => "smtp.mailgun.org",
    :port => 587,
    :domain => "sandboxad1c67663ede40459543964fd2dd9240.mailgun.org",
    :user_name => "postmaster@sandboxad1c67663ede40459543964fd2dd9240.mailgun.org",
    :password => "MYPASSWORD"
  }
